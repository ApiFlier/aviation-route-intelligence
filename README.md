...
- **Shortlist & Compare**: Users can select up to 5 routes to compare side-by-side in a compact table view, facilitating quick evaluation of multiple opportunities. Selected comparisons can be exported as a summary text or CSV.
- **Supporting Context**: Informational badges and detail sections indicate whether a route has recently observed historical carrier activity or possible recent carrier activity.
